...
time:1/useSpeedStore.getState().speed*1800/useSpeedStore.getState().speed,
  anim:(val,h,w)=>{
  ///depart: ( 69% , 13.7% )
  gsap.fromTo(".ball",{height:"2.812%",width:"1.4%",borderRadius:"50%",x:w*0.782,y:h*0.14,opacity:"0"},{opacity:"1" ,duration:1/(useSpeedStore.getState().speed)*0.5/useSpeedStore.getState().speed});
  gsap.fromTo(".ball",{x:w*0.782,y:h*0.14},{y:h*0.18 ,duration:1/(useSpeedStore.getState().speed)*0.8/useSpeedStore.getState().speed,delay:0.5/useSpeedStore.getState().speed});
  gsap.to(".ball",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.5/useSpeedStore.getState().speed,delay:1/(useSpeedStore.getState().speed)*1.3/useSpeedStore.getState().speed});
},}
const IPToMAR={
  value:"",
  target:".box-ADR",
...
const fitToMdr={
  value:"",
  target:".ball",
time:1/useSpeedStore.getState().speed*600,
  anim:(val,h,w)=>{
  gsap.fromTo(".ball",{borderRadius:"10px",width:w*0.11,height:h*0.06,x:w*0.49,y:h*0.38,opacity:"0"},{opacity:"1" ,duration:1/(useSpeedStore.getState().speed)*0.6});
...
time:1/useSpeedStore.getState().speed*600,
  anim:(val,h,w)=>{
      ...
      gsap.to(".ball",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.6});
  },}
const fitToMar={
  value:"",
  target:".ball",
time:1/useSpeedStore.getState().speed*600,
  anim:(val,h,w)=>{
  gsap.fromTo(".ball",{borderRadius:"10px",width:w*0.032,height:h*0.14,x:w*0.623,y:h*0.165,opacity:"0"},{opacity:"1" ,duration:1/(useSpeedStore.getState().speed)*0.6});
...
time:1/useSpeedStore.getState().speed*1800,
  anim:(val,h,w)=>{
  ///depart: ( 51.8% , 43.2% )
  gsap.fromTo(".ball",{height:"2.812%",width:"1.4%",borderRadius:"50%",x:w*0.539,y:h*0.445,opacity:"0"},{opacity:"1" ,duration:1/(useSpeedStore.getState().speed)*0.5});
  gsap.fromTo(".ball",{x:w*0.539,y:h*0.445},{y:h*0.465 ,duration:1/(useSpeedStore.getState().speed)*0.8,delay:1/(useSpeedStore.getState().speed)*0.5});
  gsap.to(".ball",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.5,delay:1/(useSpeedStore.getState().speed)*1.3});
},}
const MdrTOQue={
  value:"",
  target:".box-data",
time:1/useSpeedStore.getState().speed*1100,
  anim:(val,h,w)=>{
  gsap.fromTo(".box-data",{x:w*0.497,opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3})
  gsap.fromTo(".box-data",{x:w*0.497},{x:w*0.874,duration:1/(useSpeedStore.getState().speed)*0.5,delay:1/(useSpeedStore.getState().speed)*0.3})
  gsap.to(".box-data",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3,delay:1/(useSpeedStore.getState().speed)*0.8});
},}
const BusToQueue={
  value:"",
  target:".ball",
time:1/useSpeedStore.getState().speed*2400,
  anim:(val,h,w)=>{
  ///depart: ( 79.1% , 53.6% )  W:1.4% ,H:2.812
  gsap.fromTo(".ball",{height:"2.812%",width:"1.4%",borderRadius:"50%",x:w*0.931,y:h*0.56,opacity:"0"},{opacity:"1" ,duration:1/(useSpeedStore.getState().speed)*0.5});
  gsap.fromTo(".ball",{x:w*0.931,y:h*0.56},{y:h*0.6638 ,duration:1/(useSpeedStore.getState().speed)*0.7,delay:1/(useSpeedStore.getState().speed)*0.5});
  gsap.to(".ball",{x:w*0.921 ,duration:1/(useSpeedStore.getState().speed)*0.7,delay:1/(useSpeedStore.getState().speed)*1.2});
  gsap.to(".ball",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.5,delay:1/(useSpeedStore.getState().speed)*1.9});
},}

const fitqueue6={
  value:"",
  target:".queue1",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue1",{opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const fitqueue5={
  value:"",
  target:".queue2",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue2",{opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const fitqueue4={
  value:"",
  target:".queue3",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue3",{opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const fitqueue3={
  value:"",
  target:".queue4",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue4",{opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const fitqueue2={
  value:"",
  target:".queue5",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue5",{opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const fitqueue1={
  value:"",
  target:".queue6",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue6",{opacity:"0"},{opacity:"1",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
...
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue1",{opacity:"1"},{opacity:"0",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const infitqueue5={
  value:"",
  target:".queue2",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue2",{opacity:"1"},{opacity:"0",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const infitqueue4={
  value:"",
  target:".queue3",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue3",{opacity:"1"},{opacity:"0",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const infitqueue3={
  value:"",
  target:".queue4",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue4",{opacity:"1"},{opacity:"0",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const infitqueue2={
  value:"",
  target:".queue5",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue5",{opacity:"1"},{opacity:"0",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const infitqueue1={
  value:"",
  target:".queue6",
time:1/useSpeedStore.getState().speed*300,
  anim:(val,h,w)=>{
      gsap.fromTo(".queue6",{opacity:"1"},{opacity:"0",duration:1/(useSpeedStore.getState().speed)*0.3});
},}
const infitToMar={
  value:"",
  target:".ball",
...
class Queue {
    ...
    fetchInstruction(animations,num,is_animated,Contextarray,buildCTX){//for queue length cause i coudln't access directly with this.getqueuelen
        ...
        animations.push({
            value:"",
            target:"IP",
          time:1/useSpeedStore.getState().speed*IpToAdr.time,
            anim:IpToAdr.anim,
        });
        animations.push({
            value:marval,
            target:IPToMAR.target,
          time:1/useSpeedStore.getState().speed*IPToMAR.time,
            anim:IPToMAR.anim,
        });
        animations.push({
            value:marval,
        ...
        time:1/useSpeedStore.getState().speed*infitToMar.time,
      ...
      time:1/useSpeedStore.getState().speed*MCanim.time,
        ...
        animations.push({
          ...
          time:1/useSpeedStore.getState().speed*MdrTOQue.time,
            anim:MdrTOQue.anim,
        });
        animations.push({
            value:"",
            target:BusToQueue.target,
          time:1/useSpeedStore.getState().speed*BusToQueue.time,
        ...
        if(num==0){
            ...
            time:1/useSpeedStore.getState().speed*fitqueue1.time,
              anim:()=>{
                gsap.to(".queue1",{opacity:"1",duration:1/(useSpeedStore.getState().speed)*"0.2"});
                gsap.to(".queue2",{opacity:"1",duration:1/(useSpeedStore.getState().speed)*"0.2"});
              },
            });
          // animations.push({
          //   value:"",
          ...
          // time:1/useSpeedStore.getState().speed*fitqueue3.time,
          //   anim:fitqueue3.anim,
          //   });
          //   animations.push({
          //   value:"",
          //   target:infitqueue3.target,
          // time:1/useSpeedStore.getState().speed*infitqueue3.time,
          //   anim:infitqueue3.anim,
          //   });
          //   animations.push({
          //     value:"",
          //     target:fitqueue4.target,
          //   time:1/useSpeedStore.getState().speed*fitqueue4.time,
          //     anim:fitqueue4.anim,
          //     });
          //     animations.push({
          //     value:"",
          //     target:infitqueue4.target,
          //   time:1/useSpeedStore.getState().speed*infitqueue4.time,
          //     anim:infitqueue4.anim,
          //     });
          //     animations.push({
          //       value:"",
          //       target:fitqueue5.target,
          //     time:1/useSpeedStore.getState().speed*fitqueue5.time,
          //       anim:fitqueue5.anim,
          //       });
          //       animations.push({
          //       value:"",
          //       target:infitqueue5.target,
          //     time:1/useSpeedStore.getState().speed*infitqueue5.time,
          //       anim:infitqueue5.anim,
          //       });
          //       animations.push({
          //         value:"",
          //         target:fitqueue6.target,
          //       time:1/useSpeedStore.getState().speed*fitqueue6.time,
          //         anim:fitqueue6.anim,
          //         });
        }else if(num==1){
          animations.push({
          ...
          time:1/useSpeedStore.getState().speed*fitqueue1.time,
            anim:()=>{
              gsap.to(".queue3",{opacity:"1",duration:1/(useSpeedStore.getState().speed)*"0.2"});
              gsap.to(".queue4",{opacity:"1",duration:1/(useSpeedStore.getState().speed)*"0.2"});
            },
          });
          // animations.push({
          //   value:"",
          ...
          time:1/useSpeedStore.getState().speed*fitqueue1.time,
            anim:()=>{
              gsap.to(".queue5",{opacity:"1",duration:1/(useSpeedStore.getState().speed)*"0.2"});
              gsap.to(".queue6",{opacity:"1",duration:1/(useSpeedStore.getState().speed)*"0.2"});
            },
          });
          // animations.push({
          //   value:"",
    ...
    clear(animations){
      ...
      time:1/useSpeedStore.getState().speed*300,
        anim:()=>{
          gsap.to(".queue6",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3});
          gsap.to(".queue5",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3});
          gsap.to(".queue4",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3});
          gsap.to(".queue3",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3});
          gsap.to(".queue2",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3});
          gsap.to(".queue1",{opacity:"0" ,duration:1/(useSpeedStore.getState().speed)*0.3});
        },
    })
    }
    log(){
